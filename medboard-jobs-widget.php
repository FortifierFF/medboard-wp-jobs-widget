 ...
 * Update URI:        https://github.com/FortifierFF/medboard-wp-jobs-widget
 *
...
define( 'MEDBOARD_JOBS_WIDGET_VERSION', '1.0.2' );
...
require_once MEDBOARD_JOBS_WIDGET_DIR . 'includes/class-updater.php';
...
function medboard_jobs_widget_bootstrap() {
	...
	Medboard_Jobs_Widget_Updater::init();
}
